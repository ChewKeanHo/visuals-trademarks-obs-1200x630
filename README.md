# Open Broadcaster Software (OBS) Trademarks Logo 1200x630 | (Holloway) Chew, Kean Ho's Visuals

[![logo](/Pictures/banner_1200x630.svg)](#)

The OBS Trademarks Logo. They did not publish any trademark guideline left alone
...
This project re-draws OBS Trademarks Logo specifically for 1200x630 size.
...
Since OBS did not publish its brand and trademark guideline, **it is assumed
standard trademarks laws applied to avoid any unwanted legal implications**.

While not specified by OBS, please ensure the outputs are also web ready. Refer:
...
```
--------------------------------------------------------------------------------
Title: Open Broadcaster Software (OBS) Trademarks Logo 1200x630
Creators: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-trademarks-obs-1200x630
UUID: 688F2854-41F0-4A67-B24E-D5FD1CBBD9E1
License: Creative Commons Attribution-NoDerivatives 4.0 International License
Made On: 2026-02-20
Made From: Malaysia, South East Asia
Procure: https://github.com/chewkeanho/visuals-trademarks-obs-1200x630
--------------------------------------------------------------------------------
```
...
> COMPLY WITH OPEN BROADCASTER SOFTWARE (OBS) TRADEMARK REQUIREMENTS**.
>
